#include "hcr_common_markers/drag_box_marker.h"
...
void DragBoxMarker::Show() {
  ...
  im_server_->setCallback(
      name_ + "-pos_x", boost::bind(&DragBoxMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-neg_x", boost::bind(&DragBoxMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-pos_y", boost::bind(&DragBoxMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-neg_y", boost::bind(&DragBoxMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-pos_z", boost::bind(&DragBoxMarker::Feedback, this, _1));
  im_server_->setCallback(
      name_ + "-neg_z", boost::bind(&DragBoxMarker::Feedback, this, _1));
